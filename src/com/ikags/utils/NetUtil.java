...
public class NetUtil {
	...
	public static InputStream getNetInputStream(String murl,Vector<BHHeader> vec){
		URLConnection urlConn = null; 
		URL urlObject; 
		String textdata=null;
		InputStream is =null;
	...
	public static String getNetPostText(String murl,String post,Vector<BHHeader> vec,String encode){
		URLConnection urlConn = null; 
		URL urlObject; 
		String textdata=null;
		try{ 
	...
	public static Vector<BHHeader> getCustomHeaders() {
		...
		vec.add(new BHHeader("Accept", "application/json, text/javascript, */*; q=0.01"));
